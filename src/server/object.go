...
func (obj *Object) CallPickup(it *Object, a3, a4 int) bool {
	if obj.Pickup == nil {
		return obj.Server().Objs.DefaultPickup(obj, it, a3) != 0
	}
	return ccall.CallIntUPtr4(obj.Pickup, uintptr(obj.CObj()), uintptr(it.CObj()), uintptr(a3), uintptr(a4)) != 0
}
